...
import { Instagram, Sparkles, Copy, Loader } from 'lucide-react';
...
const InstagramCaptionsPage = () => {
  ...
  const generateCaptions = async () => {
    ...
    if (Math.random() > 0.1) {
      const generated = [
        `Unleash your inner viral star with ViralShorts AI! ✨ Ready to dominate your feed? #ViralShortsAI #ContentCreator #InstagramReels`,
        `Transforming long videos into 🔥 Instagram Reels in a snap with ViralShorts AI. Your audience won't know what hit 'em! #AIContent #ShortFormVideo`,
        `Level up your Instagram game. ViralShorts AI makes viral content accessible to everyone. Try it now! #GoViral #AItools`,
        `Behind every viral Reel is smart AI. Get yours with ViralShorts AI! 🚀 #InstaGrowth #VideoEditing`
      ];
  ...
  return (
    <AnimatedSection delay={0} className="w-full">
      <div className="flex items-center text-3xl font-heading text-text mb-8">
        <Instagram size={32} className="text-primary mr-3" />
        <h2>AI Instagram Caption Generator</h2>
      </div>

      <Card className="p-8 mb-8">
        <h3 className="text-xl font-heading text-text mb-6">Craft Engaging Instagram Captions</h3>
        <div className="space-y-4">
          <div>
            <label htmlFor="description" className="block text-text-muted text-sm font-medium mb-2">Short Video Description / Theme</label>
            <textarea
              id="description"
              rows="4"
              ...
              placeholder="e.g., A funny compilation of pet reactions to new toys, focused on humor and cuteness."
              value={description}
      ...
      {captions.length > 0 && (
        <AnimatedSection delay={200}>
          <Card className="p-8">
            <h3 className="text-xl font-heading text-text mb-6">Suggested Instagram Captions</h3>
            <div className="space-y-4">
